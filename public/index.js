...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Configuration2 = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Mapping.push(Object.assign({ components: __webpack_require__(6) }, { 'nameCn': '容器', 'type': 'Layout', 'styles': { 'color': { 'value': '#000000', 'type': 'color' }, 'font-size': { 'value': '16px', 'type': 'size' }, 'display': { 'value': 'block', 'type': 'select', 'items': ['block', 'inline', 'inline-block', 'none'] }, 'width': { 'value': '100%', 'type': 'size' }, 'height': { 'value': '100%', 'type': 'size' } }, 'attrs': { 'name': { 'value': 'container' } }, 'name': 'Container' }));
	Mapping.push(Object.assign({ components: __webpack_require__(11) }, { 'nameCn': '图像', 'type': 'Inline', 'attrs': { 'src': { 'type': 'file' } }, 'name': 'Image' }));
	Mapping.push(Object.assign({ components: __webpack_require__(12) }, { 'nameCn': '块级超链接', 'type': 'Block', 'name': 'LinkBlock' }));
	Mapping.push(Object.assign({ components: __webpack_require__(15) }, { 'nameCn': '文本', 'type': 'Inline', 'attrs': { 'text': { 'type': 'text', 'value': 'hello world' } }, 'name': 'Text' }));
	...
	Mapping.push(Object.assign({ components: __webpack_require__(21) }, { 'type': 'private', 'name': '_Configuration' }));
	Mapping.push(Object.assign({ components: __webpack_require__(31) }, { 'type': 'private', 'name': '_ItemMenu' }));
	Mapping.push(Object.assign({ components: __webpack_require__(22) }, { 'type': 'private', 'name': '_Preview' }));
	Mapping.push(Object.assign({ components: __webpack_require__(23) }, { 'type': 'private', 'name': '_Tree' }));
	Mapping.push(Object.assign({ components: __webpack_require__(24) }, { 'type': 'private', 'name': '_TreeNode' }));
	  ...
	  _createClass(_Preview, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        { defaultActiveKey: keys[0], unmountOnExit: true, animation: true, activeKey: cursor || keys[0], onSelect: changeTab.bind(this) },
	            ...
	            _react2.default.createElement(
	              ...
	              Object.keys(item).map(function (k) {
	                ...
	                methods.onChange = function (_ref) {
	                  ...
	                  _this2.props.complete(_this2.state.tabs);
	                };
	              ...
	              editing ? _react2.default.createElement(
	                ...
	                { bsStyle: 'success', onClick: saveData },
	                'Save'
	              ) : _react2.default.createElement(
	                _reactBootstrap.Button,
	                { disabled: true },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Preview2 = __webpack_require__(22);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TreeNode2 = __webpack_require__(24);
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          mapping.map(function (item, index, map) {
	            return [_react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ItemMenu = function (_Component) {
	  _inherits(_ItemMenu, _Component);
	
	  function _ItemMenu() {
	    _classCallCheck(this, _ItemMenu);
	
	    return _possibleConstructorReturn(this, (_ItemMenu.__proto__ || Object.getPrototypeOf(_ItemMenu)).apply(this, arguments));
	  }
	
	  _createClass(_ItemMenu, [{
	    key: 'render',
	    value: function render() {
	      var _props = this.props,
	          ...
	          return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              items.map(function (item) {
	                return _react2.default.createElement(
	                  'li',
	                  { className: _index.listitem, onClick: function onClick() {
	                      addItem(item.name);
	                    } },
	                  item.name
	                );
